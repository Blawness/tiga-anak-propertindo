...
export default function SewaLahanPage() {
    const service = siteConfig.coreServices.find((s) => s.slug === "sewa-lahan");
    ...
    return (
        <div className="space-y-12 md:space-y-16">
            ...
            <Section title="Mengapa Memilih Kami?" description="Kami mengutamakan kualitas aset dan keamanan transaksi sewa.">
                <div className="rounded-3xl bg-slate-50 p-8 md:p-12 text-center border border-slate-100">
                    <h3 className="mb-4 text-2xl font-semibold text-slate-900">Solusi Properti Terpercaya</h3>
                    <p className="mx-auto mb-8 max-w-2xl text-slate-600">
                        Kami memastikan setiap aset yang disewakan memiliki legalitas lengkap dan kondisi fisik yang prima.
                    </p>
